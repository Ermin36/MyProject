...
class TestMaskAccountCard:
    ...
    @pytest.mark.parametrize(
        "account_data, expect",
        [
            ("Счет 5123551651681616", "Счет **1616"),
            ("Счет 3515156165131305", "Счет **1305"),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("Счет 8135131", "Длина номера должна быть 16 цифр"),
            ("Master Card 45363 25345", "Номер должен быть один"),
            ("Visa", "Номер не найден"),
            ("Счет 81335165151131551", "Длина номера должна быть 16 цифр"),
        ],
    )
...
class TestDate:
    ...
    @pytest.mark.parametrize(
        "date, err_message",
        [
            ("2001.05.17T21:36:20.554235", "Не верные данные даты"),
            ("2024-03-11-02:26:18.671407", "Не верные данные даты"),
        ],
    )
